<%@page import="com.manager.example.shareModel.ConnectionType"%>
								...
								<div class='col-md-12 px-1'>
									<div class="input-group input-group-sm mb-1">
										...
										<select class="form-control" id="connectionType">
											...
											<option value="<%=connection.getType()%>"><%=connection.toString()%></option>
											<%
												}
											%>
										</select>
						...
						<div class="col-sm-6 col-md-6 col-lg-6 shadow ">
							<div class="input-group my-2">
								<input type="text" class="form-control"
									placeholder="Search Connection Point" aria-describedby="findButton"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/support/connection-point.js"></script>
