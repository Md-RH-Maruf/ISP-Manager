				...
				<div class="col-md-12 ">
					<div class="p-5">
						<div class="text-center">
							<h1 class="h4 text-gray-900 mb-4">Approved Bill</h1>
						</div>
							...
							<div class="row my-1">						
								...
								<div class="input-group input-group-sm mb-1">
									...
									<input id="approveAmount" type="text" class="form-control"
										aria-label="Sizing example input"
										aria-describedby="inputGroup-sizing-sm" value=<%=bill.getApproveAmount()%> readonly="readonly">
								</div>
							</div>
						...
						<div class="row my-1">
							...
							<div class="col-md-12">
							<button type="button" onclick="issueBillAmount()"
							class="btn btn-primary btn-user btn-block">Issue
							Bill Amount</button>
							</div>
						</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/accounts/approved-bill-details.js"></script>
