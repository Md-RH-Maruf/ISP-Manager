...
<footer class="sticky-footer bg-white">
	<div class="container my-auto">
		<div class="copyright text-center my-auto">
			<span>Copyright &copy; ISP Manager</span>
		</div>
	</div>
</footer>
<!-- End of Footer -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sb-admin-2.min.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/common/alert.js"></script>
</body>
