...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#collapseSupport"
				aria-expanded="true" aria-controls="collapseSupport"> <i
					class="fas fa-fw fa-cog"></i> <span>Support</span>
			</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseStore"> <i
					class="fas fa-fw fa-folder"></i> <span>Store</span>
			</a>
...
<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span>Setting</span>
			</a>
